...
command_help = 'To run this program, you should type {python} ./handle.py <--file> [file_name] <--method> [method_name]'
...
if __name__ == '__main__':
    ...
    try:
        ...
        if len(sys.argv) < 3:
            raise Exception('number of options < 5')
